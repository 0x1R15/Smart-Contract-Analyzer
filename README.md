# Smart Contract Vulnerability Analyzer 🛡️
...
A suite of test files is provided in the **[`test_contracts`](./test_contracts)** folder to showcase the analyzer's capabilities. Upload them directly in the UI to see the detection rules in action:
